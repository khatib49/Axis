...
namespace Application.IServices
{
    public interface ITransactionRecordService
    {
        ...
        Task<BaseResponse<TransactionDto>> CreateCoffeeShopOrder(string? phoneNumber, List<OrderItemRequest> itemsRequest, string createdBy, CancellationToken ct);

        Task<BaseResponse<TransactionDto>> CreateGameSession(string? phoneNumber, int gameId, int gameSettingId, int hours, int statusId, string createdBy, int roomSetId, CancellationToken ct = default);
