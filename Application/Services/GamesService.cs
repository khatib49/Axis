...
namespace Application.Services
{
    ...
    {
        private readonly IBaseRepository<Game> _repo;
        private readonly IUnitOfWork _uow;
        private readonly DomainMapper _mapper;

        public GameService(IBaseRepository<Game> repo, IUnitOfWork uow, DomainMapper mapper)
        {
            _repo = repo; _uow = uow; _mapper = mapper;
        }

        public async Task<GameDto?> GetAsync(int id, CancellationToken ct = default)
        {
        ...
        public async Task<PaginatedResponse<GameDto>> ListAsync(BasePaginationRequestDto pagination, CancellationToken ct = default)
        {
            ...
            return new PaginatedResponse<GameDto>(totalCount, result, pagination.Page, pagination.PageSize);
        }
        ...
        public async Task<bool> UpdateAsync(int id, GameUpdateDto dto, CancellationToken ct = default)
        {
