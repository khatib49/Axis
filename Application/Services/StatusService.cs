...
namespace Application.Services
{
    public class StatusService : IStatusService
    {
        ...
        public async Task<StatusDto?> GetAsync(int id, CancellationToken ct = default)
        {
        ...
        public async Task<PaginatedResponse<StatusDto>> ListAsync(BasePaginationRequestDto pagination, CancellationToken ct = default)
        {
            ...
            return new PaginatedResponse<StatusDto>(totalCount, result, pagination.Page, pagination.PageSize);
        }
        ...
        public async Task<bool> UpdateAsync(int id, StatusUpdateDto dto, CancellationToken ct = default)
        {
