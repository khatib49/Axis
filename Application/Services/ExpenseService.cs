...
namespace Application.Services
{
    public class ExpenseService : IExpenseService
    {
        ...
        public async Task<List<ExpenseDto>> ListAsync(CancellationToken ct = default)
        {
        ...
        public async Task<bool> UpdateAsync(Guid id, ExpenseUpdateDto dto, CancellationToken ct = default)
        {
