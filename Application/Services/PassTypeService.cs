...
namespace Application.Services
{
    public class PassTypeService : IPassTypeService
    {
        ...
        public async Task<PassTypeDto?> GetAsync(int id, CancellationToken ct = default)
        {
            var e = await _repo.GetByIdAsync(id, asNoTracking: true, ct);
            return e is null ? null : _mapper.ToDto(e);
        }

        public async Task<PaginatedResponse<PassTypeDto>> ListAsync(BasePaginationRequestDto pagination, CancellationToken ct = default)
        {
        ...
        public async Task<bool> UpdateAsync(int id, PassTypeUpdateDto dto, CancellationToken ct = default)
        {
