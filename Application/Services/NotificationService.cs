...
namespace Application.Services
{
    public class NotificationService : INotificationService
    {
        ...
        public async Task<NotificationDto?> GetAsync(int id, CancellationToken ct = default)
        {
            var e = await _repo.GetByIdAsync(id, asNoTracking: true, ct);
            return e is null ? null : _mapper.ToDto(e);
        }

        public async Task<PaginatedResponse<NotificationDto>> ListAsync(BasePaginationRequestDto pagination, CancellationToken ct = default)
        {
        ...
        public async Task<bool> UpdateAsync(int id, NotificationUpdateDto dto, CancellationToken ct = default)
        {
