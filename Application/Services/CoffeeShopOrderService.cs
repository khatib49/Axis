...
namespace Application.Services
{
    public class CoffeeShopOrderService : ICoffeeShopOrderService
    {
        ...
        public async Task<CoffeeShopOrderDto?> GetAsync(int id, CancellationToken ct = default)
        {
        ...
        public async Task<bool> UpdateAsync(int id, CoffeeShopOrderUpdateDto dto, CancellationToken ct = default)
        {
