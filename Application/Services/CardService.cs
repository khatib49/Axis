...
namespace Application.Services
{
    ...
    {
        private readonly IBaseRepository<Card> _repo;
        private readonly IUnitOfWork _uow;
        private readonly DomainMapper _mapper;

        public CardService(IBaseRepository<Card> repo, IUnitOfWork uow, DomainMapper mapper)
        {
        ...
        public async Task<PaginatedResponse<CardDto>> ListAsync(BasePaginationRequestDto pagination, CancellationToken ct = default)
        {
            ...
            return new PaginatedResponse<CardDto>(totalCount, result, pagination.Page, pagination.PageSize); 
        }

        public async Task<CardDto> CreateAsync(CardCreateDto dto, CancellationToken ct = default)
        {
