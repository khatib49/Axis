...
namespace Application.Services
{
    ...
    {
        private readonly IBaseRepository<GameSession> _repo;
        private readonly IUnitOfWork _uow;
        private readonly DomainMapper _mapper;

        public GameSessionService(IBaseRepository<GameSession> repo, IUnitOfWork uow, DomainMapper mapper)
        {
        ...
        public async Task<PaginatedResponse<GameSessionDto>> ListAsync(BasePaginationRequestDto pagination, CancellationToken ct = default)
        {
