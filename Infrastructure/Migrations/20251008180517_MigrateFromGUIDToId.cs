...
{
    /// <inheritdoc />
    public partial class MigrateFromGUIDToId : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PassTypes_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoffeeShopOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoffeeShopOrders_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CoffeeShopOrders_Cards_CardId",
                        column: x => x.CardId,
                        principalTable: "Cards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CoffeeShopOrders_Items_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GameSessions_Cards_CardId",
                        column: x => x.CardId,
                        principalTable: "Cards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GameSessions_PassTypes_PassTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameId = table.Column<int>(type: "integer", nullable: true),
                    GameSettingId = table.Column<int>(type: "integer", nullable: true),
                    StatusId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransactionItems", x => new { x.TransactionRecordId, x.ItemId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransactionItems_transactions_TransactionRecordId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoffeeShopOrders_CardId",
                table: "CoffeeShopOrders",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_CoffeeShopOrders_ItemId",
                table: "CoffeeShopOrders",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_CoffeeShopOrders_UserId",
                table: "CoffeeShopOrders",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameSessions_PassTypeId",
                table: "GameSessions",
                column: "PassTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PassTypes_GameId",
                table: "PassTypes",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_Receipts_CardId",
                table: "Receipts",
                column: "CardId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionItems_TransactionRecordId",
                table: "TransactionItems",
